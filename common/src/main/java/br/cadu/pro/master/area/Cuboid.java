package br.cadu.pro.master.area;
...
public class Cuboid implements Iterable<Block>, Cloneable, ConfigurationSerializable {
    ...
    public static Location maximize2D(Location center, double radius) {
        return new Location(center.getWorld(), center.getX() + radius, center.getY(), center.getZ() + radius);
    }

    public static Location minimize2D(Location center, double radius) {
        return new Location(center.getWorld(), center.getX() - radius, center.getY(), center.getZ() - radius);
    }
    ...
    public Cuboid(Location center, double radius) {
    ...
    public List<Block> getLayer(int y) {
