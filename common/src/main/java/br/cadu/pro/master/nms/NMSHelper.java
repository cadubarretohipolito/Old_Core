...
import br.cadu.pro.master.SkyBlockCore;
...
public class NMSHelper {
    ...
    public Class<?> getNMSClass(String name) {
        return Class.forName("net.minecraft.server." + SkyBlockCore.getInstance().getServer().getVersion() + "." + name);
    }

    @SneakyThrows
    public Class<?> getCraftBukkitClass(String name) {
        return Class.forName("org.bukkit.craftbukkit." + SkyBlockCore.getInstance().getServer().getVersion() + "." + name);
    }
